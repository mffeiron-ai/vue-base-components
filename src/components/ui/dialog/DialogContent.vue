...
<template>
  <DialogPortal>
    ...
    <DialogContent
      ...
      :class="
        cn(
          'cn-anim-overlay bg-background fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border border-input p-6 shadow-lg sm:max-w-lg [&>*]:min-w-0',
          props.class,
        )"
    >
      <slot />
