...
<script setup>
import { Questionnaire, QuestionnaireActions, QuestionnaireChoice, QuestionnaireChoices, QuestionnaireDescription, QuestionnaireError, QuestionnaireItem, QuestionnaireNext, QuestionnairePrevious, QuestionnaireProgress, QuestionnaireSkip, QuestionnaireSubmit, QuestionnaireTitle, } from '../../src/components/ui/questionnaire'
...
const demo1 = `<QuestionnaireError>
    {{ errors.detail }}
</QuestionnaireError>`

const demo2 = `<QuestionnaireTitle as-child>
